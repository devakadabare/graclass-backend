...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Not authorized to view this class' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Class not found' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Not authorized to update this class' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Class not found' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Not authorized to cancel this class' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Class not found' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Not authorized to delete this class' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
